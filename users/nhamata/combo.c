...
const uint16_t PROGMEM unds_combo[] = {LI5, LM0, COMBO_END}; // _ KC_UNDS
const uint16_t PROGMEM eql_combo[] = {RI5, RM0, COMBO_END}; // = KC_EQL
const uint16_t PROGMEM labk_combo[] = {LI5, LR0, COMBO_END}; // < KC_LABK
const uint16_t PROGMEM rabk_combo[] = {RI5, RR0, COMBO_END}; // > KC_RABK
const uint16_t PROGMEM mins_combo[] = {LI5, LM5, COMBO_END}; // - KC_MINS 
const uint16_t PROGMEM scln_combo[] = {RI5, RM5, COMBO_END}; // ; KC_SCLN
...
const uint16_t PROGMEM grv_combo[] = {LM0, LP0, COMBO_END}; // ` KC_GRV
const uint16_t PROGMEM tild_combo[] = {RM0, RP0, COMBO_END}; // ~ KC_TILD
const uint16_t PROGMEM esc_combo[] = {LR0, LP0, COMBO_END}; // KC_ESC
const uint16_t PROGMEM caps_combo[] = {RR0, RP0, COMBO_END}; // KC_CAPS
const uint16_t PROGMEM lbrc_combo[] = {LI0, LP0, COMBO_END}; // [ KC_LBRC
const uint16_t PROGMEM rbrc_combo[] = {RI0, RP0, COMBO_END}; // ] KC_RBRC
#endif
