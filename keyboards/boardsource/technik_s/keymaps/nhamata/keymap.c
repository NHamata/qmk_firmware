...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    _______,             _______,          _______,                            MO(1),            LSFT_T(KC_SPC),                     MO(1),            MO(2),            _______,          _______,          _______
  ),
  [1] = LAYOUT(
    KC_F1,               KC_F2,            KC_F3,            KC_F4,            KC_F6,            _______,          KC_F8,            KC_F9,            KC_F10,            KC_F11,          KC_F12,           _______,
    KC_6,                KC_4,             KC_2,             KC_0,             KC_F5,            _______,          KC_F7,            KC_1,             KC_3,              KC_5,            KC_7,
